...
public class HttpConnection
{
    ...
    private void executeMethod() {
        ...
        if (request.getType() == RequestType.GET) {
            ...
            if (request.getContentType() == org.intermine.client.core.ContentType.MULTI_PART_FORM) {
    ...
    protected void handleErrorResponse() throws IOException {
        ...
        switch (executedMethod.getStatusCode()) {
            ...
            case HttpURLConnection.HTTP_INTERNAL_ERROR:
                if (message != null) {
                    throw new org.intermine.client.exceptions.InternalErrorException(message);
                } else {
                    throw new org.intermine.client.exceptions.InternalErrorException(this);
                }
