...
public class URLParserTest extends TestCase
{
    ...
    public void testParseServiceUrl() throws MalformedURLException {
        String url = "http://beta.flymine.org/beta/service/template/results?name=AllGene_Chromosome&op1=eq&value1=Drosophila+melanogaster&size=10&format=tab";
        String serviceUrl = URLParser.parseServiceUrl(url);
        assertEquals("http://beta.flymine.org/beta/service/template/results", serviceUrl);
    }
